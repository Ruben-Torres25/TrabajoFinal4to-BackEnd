...
let IndiceService = class IndiceService {
    ...
    async obtenerIndices() {
        try {
            const response = await axios_1.default.get(`${this.apiUrl}indices`);
            ...
            console.error(error);
            throw new common_1.HttpException('Error al obtener y guardar índices', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async findAll() {
